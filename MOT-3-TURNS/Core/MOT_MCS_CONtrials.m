function [data, config] = MOT_MCS_CONtrials(subject_name, num_trials, base_speed, speed_inc)
...
%   first stage.
    ...
    try
        ...
        for trial_num = 1:num_trials
            ...
            trial = MOT_Trial_CON(config, io_, [TaskType.MOT TaskType.VWM], speeds(trial_num), QuadrantLayout.All, []);
    ...
    try
        ...
        for i=1:num_trials
           ...
           % io_.DisplayMessageAndWait(message);
            ...
            io_.DisplayMessageAndWaitMed(message);         
