function MOT_TURNS(subject_name)
    ...
    ListenChar(2);
    fprintf('PARTICIPANT STAGE: Give wordsearch to confederate, press any key to start...\n');
    GetKbChar();
    ...
    trialtype = 'CONFEDERATE';
    trial1_subject = [subject_name trialtype];
    
    
    ListenChar(2);
    fprintf('CONFEDERATE STAGE: Give wordsearch to participant, press any key to start...\n');
    GetKbChar();
    MOT_MCS_C1(trial1_subject, 18, 3, 1);
