function SoloRandomMOT(subject_name)
    ...
    trialtype = 'Trial_P';
    practice_subject = [subject_name trialtype];
    
    
    ListenChar(2);
    fprintf('Please press a key to begin the ONLY stage...\n');
    GetKbChar();
    speed = MOT_MCS_Practice(practice_subject, 18, 3, 1);
